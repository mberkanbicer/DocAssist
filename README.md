...
![A Word document that contains content generated by DocAssist.](./assets/thumbnail.png)

This sample shows how to use DocAssist to enhance document creation and editing with AI capabilities. You'll learn how to:
